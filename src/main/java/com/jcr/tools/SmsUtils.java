...
public class SmsUtils {
    ...
    {
        SendSmsResponse response = sendSms("15629013769","456789");
        System.out.println(response.getCode());
        System.out.println(response.getMessage());
        QuerySendDetailsResponse qr=querySendDetails("15273068536");
    ...
    public static SendSmsResponse sendSms(String phoneNumbers, String code) throws ClientException
    {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("龙腾");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_161593380");
        //设置参数
